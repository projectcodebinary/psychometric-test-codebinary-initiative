...
if(isset($_POST['submit']))
{
    ...
    $sql="INSERT INTO responses (email,ques, ques2, ques3 ,ques4, ques5, ques6, ques7, ques8, ques9, ques10) VALUES ('$y','$x','$a','$b','$c','$d','$e','$f','$g', '$h','$i')";
                    ...
                    <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="email" placeholder="Enter your Email Address" style="min-height: inherit;"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" >
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message1" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message2" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message3" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message4" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">
                                ...
                                <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message5" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message6" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message7" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message8" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message9" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message10" placeholder="Enter your answer"required></textarea>
                                </div>
                            </div>
                        </div>
                        <input type="submit" name="submit" href="index12.php"style=" font-size: large; background-color: gray; font-family: serif;">
